...
namespace BookingHotel.Web.ViewComponents
{
    ...
    public class vcProductHot : ViewComponent
    {
        ...
        #endregion
        #region Ctor
        public vcProductHot(IHttpClientFactory clientFactory, ILogging logging, IOptions<Config> config)
        {
        ...
        {
            var response = await client.GetAsync($"api/product/getnew?NumberItem={8}");
