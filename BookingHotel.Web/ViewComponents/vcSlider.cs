...
namespace BookingHotel.Web.ViewComponents
{
    ...
    public class vcSlider : ViewComponent
    {
        ...
        #endregion
        #region Ctor
        public vcSlider(IHttpClientFactory clientFactory, ILogging logging, IOptions<Config> config)
        {
        ...
        {
            var response = await client.GetAsync($"api/banner/getallstatus?status=true");
